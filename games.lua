...
if RAMBOBOT:get(RAMBO_ID.."chencher"..msg.sender_user_id_) then 
if RAMBOBOT:get(RAMBO_ID.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
ramin = '['..(RAMBOBOT:get(RAMBO_ID.."chencher"..msg.sender_user_id_) or '')..']'
...
RAMBOBOT:set(RAMBO_ID.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
if text == (RAMBOBOT:get(RAMBO_ID..':Set_Hzorh:'..msg.chat_id_) or '&57788') then -- // حزوره
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:del(RAMBO_ID..':Set_Hzorh:'..msg.chat_id_)
t = '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end

if text == (RAMBOBOT:get(RAMBO_ID..':Set_Amthlh:'..msg.chat_id_) or '*678988') then -- // امثله
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:del(RAMBO_ID..':Set_Amthlh:'..msg.chat_id_)
t = '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end

if text == (RAMBOBOT:get(RAMBO_ID..':Set_alii:'..msg.chat_id_) or '*67888') then -- // المختلف
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:del(RAMBO_ID..':Set_alii:'..msg.chat_id_)
t= '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end 

if (text == (RAMBOBOT:get(RAMBO_ID.."GAME:CHER"..msg.chat_id_) or '&6-88')) then  
t = '📮¦ اجابتك صحيحه ذكي وربي 😙'
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:del(RAMBO_ID.."GAME:S"..msg.chat_id_)
RAMBOBOT:del(RAMBO_ID.."GAME:CHER"..msg.chat_id_)
...
if RAMBOBOT:get(RAMBO_ID.."GAME:S"..msg.chat_id_) then  
...
if text == ''..(RAMBOBOT:get(RAMBO_ID..'SMALE:GAME'..msg.chat_id_) or '')..'' and not RAMBOBOT:get(RAMBO_ID..'SMALE:GAMES'..msg.chat_id_) then
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:set(RAMBO_ID..'SMALE:GAMES'..msg.chat_id_,true)
NUMPGAME = (RAMBOBOT:get(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊¦ مبروك فزت 🍂\n🎁¦ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭¦* للعب مره اخرى ارسل `الاسرع` \n', 1, 'md')
end 

if text == ''..(RAMBOBOT:get(RAMBO_ID..'CHEK:CHER'..msg.chat_id_) or '')..'' and not RAMBOBOT:get(RAMBO_ID..'RTEP:CHER'..msg.chat_id_) then
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:set(RAMBO_ID..'RTEP:CHER'..msg.chat_id_,true)
NUMPGAME = (RAMBOBOT:get(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_))
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊¦ مبروك فزت 🍂\n🎁¦ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭¦* للعب مره اخرى ارسل `معاني` \n', 1, 'md')
end 

if text == ''..(RAMBOBOT:get(RAMBO_ID..'klmo'..msg.chat_id_) or 'لفاتع')..'' and not RAMBOBOT:get(RAMBO_ID..'CHER:GAME'..msg.chat_id_) then
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
RAMBOBOT:set(RAMBO_ID..'CHER:GAME'..msg.chat_id_,true)
NUMPGAME = (RAMBOBOT:get(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'*🎊¦ مبروك فزت 🍂\n🎁¦ اصبح عدد نقودك » { '..NUMPGAME..' }\n🎭¦* للعب مره اخرى ارسل `ترتيب` \n', 1, 'md')
end 

if RAMBOBOT:get(RAMBO_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
RAMBOBOT:del(RAMBO_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = RAMBOBOT:get(RAMBO_ID..'SET:ID:USER'..msg.chat_id_)  
rami = "\n📬*¦ روح خالي 😉 تم اضافة له { "..text:match("^(%d+)$").." }* رساله"
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md') 
RAMBOBOT:incrby(RAMBO_ID..'user:messages:'..msg.chat_id_..':'..GET_IDUSER,text:match("^(%d+)$"))  

end
RAMBOBOT:del(RAMBO_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end

if RAMBOBOT:get(RAMBO_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^(%d+)$") then
if tonumber(text:match("^(%d+)$")) > 50000 then
rami = "*📬¦ لا تستطيع اضافة اكثر من 1000 نقطه\n*"
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md') 
RAMBOBOT:del(RAMBO_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = RAMBOBOT:get(RAMBO_ID..'SET:ID:USER:NUM'..msg.chat_id_)  
rami = "\n📬*¦ طكو طكو عمي 😻 تم اضافة له { "..text:match("^(%d+)$").." }* نقطه"
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md') 
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..GET_IDUSER, text:match("^(%d+)$"))  
end
RAMBOBOT:del(RAMBO_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end


if RAMBOBOT:get(RAMBO_ID.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1,"*📬¦ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*\n", 1, "md")    
return false  end 
local GETNUM = RAMBOBOT:get(RAMBO_ID.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
RAMBOBOT:del(RAMBO_ID.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1,'*📮¦ مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊¦ لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *', 1, "md")    
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
...
if RAMBOBOT:get(RAMBO_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1,"*📬¦ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n", 1, "md")    
return false  end 
local GETNUM = RAMBOBOT:get(RAMBO_ID.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
RAMBOBOT:del(RAMBO_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
RAMBOBOT:del(RAMBO_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
RAMBOBOT:incrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,5)  
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1,'*🔖¦ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸¦ تم اضافة { 5 } من النقاط *\n', 1, "md")    
elseif tonumber(NUM) ~= tonumber(GETNUM) then
RAMBOBOT:incrby(RAMBO_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(RAMBOBOT:get(RAMBO_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
RAMBOBOT:del(RAMBO_ID..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
RAMBOBOT:del(RAMBO_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if chat_type == 'super' then 
if not RAMBOBOT:get(RAMBO_ID.."LOCK:GAMES"..msg.chat_id_) then 
if MSG_TEXT[1] == 'محيبس' or MSG_TEXT[1] == 'بات' then   
Num = math.random(1,6)
RAMBOBOT:set(RAMBO_ID.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
RAMBOBOT:setex(RAMBO_ID.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end

if MSG_TEXT[1] == 'خمن' or MSG_TEXT[1] == 'تخمين' then   
Num = math.random(1,20)
RAMBOBOT:set(RAMBO_ID.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n📮¦ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'⚠¦ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'🔖¦ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ \n🎊¦ الفائز سيحصل على { 5 } من النقود \n💥*'
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, TEST, 1, "md") 
RAMBOBOT:setex(RAMBO_ID.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if MSG_TEXT[1] == 'اسئله' or MSG_TEXT[1] == 'ختيارات' or MSG_TEXT[1] == 'بدء الاسئله' then   
RAMBOBOT:set(RAMBO_ID.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
RAMBOBOT:set(RAMBO_ID.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,SENDTEXT, 1, 'md')
return false  
end
...
RAMBOBOT:set(RAMBO_ID..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
RAMBOBOT:set(RAMBO_ID..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
RAMBOBOT:set(RAMBO_ID..':Set_Hzorh:'..msg.chat_id_,name)
...
if MSG_TEXT[1] == 'الاسرع' and not RAMBOBOT:get(RAMBO_ID.."LOCK:GAMES"..msg.chat_id_) then 
RAMBOBOT:del(RAMBO_ID..'SMALE:GAMES'..msg.chat_id_)
katu = {'🍏','🍎','843578','9755','25677','578866','14589','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚕','7643','93289','3457','95439','378865','24568','9976','289','2288','2854','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
RAMBOBOT:set(RAMBO_ID..'SMALE:GAME'..msg.chat_id_,katu[math.random(#katu)])
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'اسرع واحد يدز هذهہٓ ››  `'..RAMBOBOT:get(RAMBO_ID..'SMALE:GAME'..msg.chat_id_)..'`', 1, 'md')
end

if MSG_TEXT[1] == 'معاني' and not RAMBOBOT:get(RAMBO_ID.."LOCK:GAMES"..msg.chat_id_) then 
RAMBOBOT:del(RAMBO_ID..'RTEP:CHER'..msg.chat_id_)
...
name = katu[math.random(#katu)]
RAMBOBOT:set(RAMBO_ID..'CHEK:CHER'..msg.chat_id_,name)
...
if MSG_TEXT[1] == 'ترتيب' and not RAMBOBOT:get(RAMBO_ID.."LOCK:GAMES"..msg.chat_id_) then 
RAMBOBOT:del(RAMBO_ID..'CHER:GAME'..msg.chat_id_)
...
name = katu[math.random(#katu)]
RAMBOBOT:set(RAMBO_ID..'klmo'..msg.chat_id_,name)
...
if tonumber((RAMBOBOT:get(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
...
return false end
if tonumber(RAMBOBOT:get(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == 0 then
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ ليس لديك نقود من الالعاب \n📬¦ اذا كنت تريد ربح النقود \n🎮¦ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
else
local NUM_GAMES = RAMBOBOT:get(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'\n*📮¦ ليس لديك نقود بهاذا العدد \n📬¦ لزيادة نقودك في اللعبه \n🎮¦ ارسل الالعاب وابدأ اللعب ! *', 1, 'md') 
return false end
local NUMNKO = (NUMPY * 50)
RAMBOBOT:decrby(RAMBO_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
RAMBOBOT:incrby(RAMBO_ID..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
...
return false  end 
if RAMBOBOT:get(RAMBO_ID..'LOCK:GAMES'..msg.chat_id_) then
rami = '*📮¦ تم تفعيل الالعاب في المجموعه *\n✓' 
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOBOT:del(RAMBO_ID..'LOCK:GAMES'..msg.chat_id_) 
else
...
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOBOT:set(RAMBO_ID..'LOCK:GAMES'..msg.chat_id_,true) 
else
...
RAMBOBOT:set(RAMBO_ID..'SET:ID:USER'..msg.chat_id_,ID_USER)  
RAMBOBOT:setex(RAMBO_ID.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'*📊¦ ارسل لي عدد الرسائل الذي تريده*\n', 1, 'md') 
end
...
return false  end 
local ID_USER = MSG_TEXT[2]
RAMBOBOT:set(RAMBO_ID..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
RAMBOBOT:setex(RAMBO_ID.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1,'*📊¦ ارسل لي عدد النقاط الذي تريده*\n', 1, 'md') 
end
