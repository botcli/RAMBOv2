...
if RAMBOBOT:get(RAMBO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
RAMBO_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
RAMBOBOT:del(RAMBO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
...
if RAMBOBOT:get(RAMBO_ID..'lock:skrfa'..msg.chat_id_)  then
rami = '*📮¦ تم تفعيل الزخرفه *\n✓' 
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOBOT:del(RAMBO_ID..'lock:skrfa'..msg.chat_id_) 
else
...
if not RAMBOBOT:get(RAMBO_ID..'lock:skrfa'..msg.chat_id_)  then
rami = '*📮¦ تم تعطيل الزخرفه *\n✓' 
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOBOT:set(RAMBO_ID..'lock:skrfa'..msg.chat_id_,true) 
else
...
if not RAMBOBOT:get(RAMBO_ID.."lock:skrfa"..msg.chat_id_) then   
RAMBOBOT:setex(RAMBO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
