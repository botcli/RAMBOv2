...
if RAMBOv2BOT:get(RAMBOv2_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
RAMBOv2BOT:del(RAMBOv2_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
if utf8.len(text) > 20 then
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ لا يمكن زخرفة اكثر من 20 حرف *', 1, 'md') 
RAMBOv2BOT:del(RAMBOv2_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, SEND_SKRF,  1, "md")
RAMBOv2BOT:del(RAMBOv2_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
end
end
end
...
if RAMBOv2BOT:get(RAMBOv2_ID..'lock:skrfa'..msg.chat_id_)  then
rami = '*📮¦ تم تفعيل الزخرفه *\n✓' 
RAMBOv2_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOv2BOT:del(RAMBOv2_ID..'lock:skrfa'..msg.chat_id_) 
else
rami = '*📮¦ بالتاكيد تم تفعيل الزخرفه  *\n✓' 
RAMBOv2_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
end
return false
end
if MSG_TEXT[1] == 'تعطيل الزخرفه' and is_mod(msg) then   
if not RAMBOv2BOT:get(RAMBOv2_ID..'lock:skrfa'..msg.chat_id_)  then
rami = '*📮¦ تم تعطيل الزخرفه *\n✓' 
RAMBOv2_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOv2BOT:set(RAMBOv2_ID..'lock:skrfa'..msg.chat_id_,true) 
else
rami = '*📮¦ بالتاكيد تم تعطيل الزخرفه  *\n✓' 
RAMBOv2_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
end
return false
end
...
if not RAMBOv2BOT:get(RAMBOv2_ID.."lock:skrfa"..msg.chat_id_) then   
RAMBOv2BOT:setex(RAMBOv2_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
local t = '*⚡¦* ارسل الاسم الذي تريد زخرفته \n*📬¦* سواء كان بالعربي او بالانكلش 🍁'   
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
else
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ الزخرفه معطله *', 1, 'md') 
end
return false
end
