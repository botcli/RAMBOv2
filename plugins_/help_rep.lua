...
if not RAMBOv2BOT:get(RAMBOv2_ID..'lock:reoly:bot'..msg.chat_id_) then
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,rami8[math.random(#rami8)], 1, 'html') 
end
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,rami9[math.random(#rami9)], 1, 'html') 
end
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,rami10[math.random(#rami10)], 1, 'html') 
end
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, ''..rami[math.random(#rami)]..'', 1, 'md')
end 
...
'هـايـات يـروحـي┋🌸', 
'يههلا بيك حياتي 💛🌿'}      RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, ''..rami[math.random(#rami)]..'', 1, 'md')   
end
...
'ﯛ୭ﯠ۶ـہٰٰٰٖٖٖلہٰٰٰٖٖٖيکگہٰٰٰٖٖٖمہٰٰٰٖٖٖہ ٵٴلہٰٰٰٖٖٖسہلہٰٰٰٖٖٖاٴمہٰٰٰٖٖٖہ ┆ ➰✌️🏿'}  RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, ''..rami[math.random(#rami)]..'', 1, 'md') 
end 
...
if text =="🌚" then 
rami =   "• فـﮧديت صخـﮧامك🙊👄" 
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, rami, 1, "html") 
end
if text == "🌚🌚" then 
rami =   "• فـﮧديت صخـﮧامك🙊👄" 
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, rami, 1, "html") 
...
if text =="شبيكم" then 
rami =   "مبينه شي سلامتك/ ج🎈😌"   RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, rami, 1, "html") 
end
if text =="شبيكك" then 
rami =   "مبينه شي سلامتك/ ج🎈😌" 
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, rami, 1, "html") 
...
if RAMBOv2BOT:get(RAMBOv2_ID..'lock:reoly:bot'..msg.chat_id_) then
rami = '*📮¦ تم تفعيل ردود البوت *\n✓' 
RAMBOv2_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOv2BOT:del(RAMBOv2_ID..'lock:reoly:bot'..msg.chat_id_) 
else
...
RAMBOv2_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOv2BOT:set(RAMBOv2_ID..'lock:reoly:bot'..msg.chat_id_,true) 
else
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1,delac, 1, 'md')
 end

if MSG_TEXT[1] == 'الاوامر' then
if not is_mod(msg) then 
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن الادمنيه 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
rami = [[
⚠️
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن المدراء 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
rami = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
📮¦ في اوامــر المدراء 
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن المنشئين 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
rami = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
📮¦ في اوامــر المنڜئين'
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن المطورين 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
rami = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
...
RAMBOv2_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست المطور الاساسي 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
rami = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
