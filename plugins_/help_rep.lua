...
if not RAMBOBOT:get(RAMBO_ID..'lock:reoly:bot'..msg.chat_id_) then
...
if RAMBOBOT:get(RAMBO_ID..'lock:reoly:bot'..msg.chat_id_) then
rami = '*📮¦ تم تفعيل ردود البوت *\n✓' 
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOBOT:del(RAMBO_ID..'lock:reoly:bot'..msg.chat_id_) 
else
...
RAMBO_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
RAMBOBOT:set(RAMBO_ID..'lock:reoly:bot'..msg.chat_id_,true) 
else
